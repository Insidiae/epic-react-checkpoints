...
//* Optional: Refactor `updateUser` so that the user of this API
// can accept the updated user value and/or handle errors as needed.
...
function UserSettings() {
  ...
  function handleSubmit(event) {
    ...
    //* Optional: You can also chain `.then` or `.catch` if you need it
    // .catch(error => {
