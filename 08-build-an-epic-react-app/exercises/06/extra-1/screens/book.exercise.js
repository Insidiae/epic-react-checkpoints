...
// 💯 You'll need some custom hooks from 'utils/books'
...
function BookScreen({ user }) {
  ...
  // 💯 Replace these useQuery calls with our new custom hooks
...
function NotesTextarea({ listItem, user }) {
  // 💯 Replace theis useMutation call with our new custom hooks
