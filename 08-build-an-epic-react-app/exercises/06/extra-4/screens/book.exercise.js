...
// 💯 You'll need the Spinner from `components/lib`
...
function NotesTextarea({ listItem, user }) {
  // 💯 You can get isLoading from the mutation query
  const [mutate, { isLoading, error, isError }] = useUpdateListItem(user);
  ...
  return (
    <React.Fragment>
      <div>
        ...
        {/* 💯 Try to add an inline loading spinner to the notes */}
