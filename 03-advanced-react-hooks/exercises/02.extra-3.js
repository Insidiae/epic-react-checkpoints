...
// 💯 See if you can make a reusable hook that only
// calls `dispatch` if the component is mounted.
...
function useAsync(initialState) {
  ...
  // 💯 Prevent `dispatch` from being called if the component is unmounted.
